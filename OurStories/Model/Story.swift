    ...
    static func storyGenerate() ->[Story]
    {
        return [
            ...
            Story(location: "奥地利-萨尔茨堡",
                  storyContent: "2016年1月 我们开始了新一次的旅行 这次我们飞到了萨尔茨堡 莫扎特出生的地方 记得机场在山中不大 出了机场以后 坐着公交车很快就到了城中的酒店 现在感觉已经没有太多的印象了 只记得一个在山顶上的城堡十分壮观 还有就是莫扎特雕像和随处可听见的音乐声了...",
                  imageName: "20.png",
                  coordinate: CLLocationCoordinate2D(latitude: 47.809490, longitude: 13.055010)),

            Story(location: "奥地利-哈尔斯塔特",
                  storyContent: "2016年1月 我们搭火车从萨尔茨堡去往哈尔斯塔特 一路上景色很美 但是当我们到达这个小镇的车站的时候 终于明白了为什么这个小镇可以被称为最美小镇 那天天气不错 我们在小镇里走了走 还爬了山 山景的景色更加的好看 可惜的是由于季节不对 矿洞没有开门 真是是值得再去一次的地方 不是吗...",
                  imageName: "21.png",
                  coordinate: CLLocationCoordinate2D(latitude: 47.557281, longitude: 13.646960)),

            Story(location: "意大利-威尼斯",
                  storyContent: "2016年1月 我们搭火车进入了意大利来到了威尼斯 记得火车在接近目的地的时候周围已经被大雾所包围了 下车去酒店的一路都是大雾和昏暗的路灯 不记得我们两个拖着箱子走了多久 翻过了多少座桥 终于找到了酒店 我们去了威尼斯著名的广场 面具集市 当然也坐船去了那几座岛 房子五颜六色很是漂亮 但是如果夏天去的话可能感觉会更好吧...",
                  imageName: "22.png",
                  coordinate: CLLocationCoordinate2D(latitude: 45.440845, longitude: 12.315515)),

            Story(location: "意大利-维罗纳",
                  storyContent: "2016年1月 一个很浪漫的城市 罗密欧与朱丽叶生死相恋的地方 我们去了他们的故居 在墙上写下了我们的名字...",
                  imageName: "23.png",
                  coordinate: CLLocationCoordinate2D(latitude: 45.438618, longitude: 10.993313)),

            Story(location: "德国-天鹅堡",
                  storyContent: "2016年1月 这个是你来过第二次的地方 不知道这次你有感觉到不一样吗 记得这里有一个旧天鹅堡和一个新天鹅堡 那天很冷 我们参观了新天鹅堡的内部 听了公爵的故事 我们还爬上了一座小山去拍它后面的样子 很可惜后面的吊桥没有开...",
                  imageName: "24.png",
                  coordinate: CLLocationCoordinate2D(latitude: 47.576431, longitude: 10.732980)),

            Story(location: "德国-慕尼黑",
                  storyContent: "2016年1月 我们这次旅行的最后一个城市 我们在这里还和Emily见面了 记得在一个像大食堂的地方 我们喝了黑啤 吃了猪肘 然后一起去逛了博物馆 美好充实的一天...",
                  imageName: "25.png",
                  coordinate: CLLocationCoordinate2D(latitude: 48.135124, longitude: 11.581981)),

            Story(location: "葡萄牙-里斯本",
                  storyContent: "2016年6月 我们来到了里斯本 这里真的是超美的 我们登上了耶稣像 俯瞰里斯本 见到了和旧金山大桥一样的跨海大桥 吃到了葡式蛋挞 还去了欧洲最西端 好的心情就如同好的天气...",
                  imageName: "26.png",
                  coordinate: CLLocationCoordinate2D(latitude: 38.722252, longitude: -9.139337)),

            Story(location: "匈牙利-布达佩斯",
                  storyContent: "2017年1月 多瑙河横跨的布达与佩斯 一月的这里寒冷刺骨 走在城市的街道上 看着城市中胸围的建筑 确实能让人感觉到曾经的奥匈帝国雄伟...",
                  imageName: "27.png",
                  coordinate: CLLocationCoordinate2D(latitude: 47.497913, longitude: 19.040236)),

            Story(location: "捷克-布拉格",
                  storyContent: "2017年1月 第一次坐跨国大巴 我们来到了布拉格 走过了这里的广场才发现并没有许愿池...",
                  imageName: "28.png",
                  coordinate: CLLocationCoordinate2D(latitude: 50.075539, longitude: 14.437800)),

            Story(location: "捷克-CK小镇",
                  storyContent: "2017年1月 第一次在欧洲自驾 记得大雪封路 语言不通 当地的警察让我们跟着好心的路人一路绕过了封路的地段 还记得一路上下了好大的❄️...",
                  imageName: "29.png",
            ...
            Story(location: "爱尔兰-利莫瑞克",
                  storyContent: "测试段落测试段落测试段落测试段落测试段落测试段落测试段落测试段落测试段落测试段落测试段落测试段落测试段落",
                  imageName: "3.png",
                  coordinate: CLLocationCoordinate2D(latitude: 52.668018, longitude: -8.630498)),
            
            Story(location: "爱尔兰-都柏林 - Rotunda Hospital",
                  storyContent: "2021年7月7日 这一天我们牛牛出生啦 ",
                  imageName: "2.png",
                  coordinate: CLLocationCoordinate2D(latitude: 53.3531, longitude: -6.2632)),
            
            Story(location: "爱尔兰-都柏林 - The Pig Ears",
                  storyContent: "牛牛100天",
                  imageName: "2.png",
                  coordinate: CLLocationCoordinate2D(latitude: 53.301919, longitude: -6.151080)),
